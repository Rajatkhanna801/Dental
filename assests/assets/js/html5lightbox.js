    ...
    (function($) {
        $.fn.html5lightbox = function(options) {
            ...
            inst.createMarkup = function() {
                ...
                if (inst.options.stamp) inst.$watermark.html("<a href='" + inst.options.freelink + "' style='text-decoration:none;' title='jQuery Lightbox'><div style='display:block;width:0px;height:20px;text-align:center;border-radius:3px;-moz-border-radius:3px;-webkit-border-radius:3px;background-color:#fff;color:#333;font:0px Arial,sans-serif;'><div style='line-height:20px;'>" +
